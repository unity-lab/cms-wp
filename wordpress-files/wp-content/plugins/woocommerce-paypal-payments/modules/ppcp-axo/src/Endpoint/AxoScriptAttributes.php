...
class AxoScriptAttributes implements EndpointInterface
{
    ...
    public function __construct(RequestData $request_data, LoggerInterface $logger, SdkClientToken $sdk_client_token, bool $axo_eligible)
    {
    ...
    public function handle_request(): bool
    {
        ...
        if (!$this->axo_eligible || is_user_logged_in() || $this->is_paypal_continuation()) {
